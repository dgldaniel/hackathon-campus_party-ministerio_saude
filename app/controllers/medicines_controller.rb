class MedicinesController < ApplicationController
  ...
  private
    ...
    def medicine_params
      params.require(:medicine).permit(:codigoCatmat, :viaAdministracao, :dose, :doseUnica, :usoContinuo, :doseFrequenciaTipo, :doseFrequencia, :doseFrequenciaQuantidade, :doseFrequenciaUnidadeMedida, :dtInicioTratamento, :duracaoTratamento, :duracaoTratamentoMedida, :quantidadeReceitada)
    end
end
