class FamiliesController < ApplicationController
  ...
  private
    ...
    def family_params
      params.require(:family).permit(:dataNascimentoResponsavel, :numeroCnsResponsavel, :numeroMembrosFamilia, :numeroProntuario, :rendaFamiliar, :resideDesde, :stMudanca, :references)
    end
end
