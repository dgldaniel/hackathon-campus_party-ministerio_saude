...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { codigoExame: @exam.codigoExame, solicitadoAvaliado: @exam.solicitadoAvaliado } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { codigoExame: @exam.codigoExame, solicitadoAvaliado: @exam.solicitadoAvaliado } }
