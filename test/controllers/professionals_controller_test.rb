...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post professionals_url, params: { professional: { cnsProfissional: @professional.cnsProfissional, codigoCbo2002: @professional.codigoCbo2002 } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { cnsProfissional: @professional.cnsProfissional, codigoCbo2002: @professional.codigoCbo2002 } }
